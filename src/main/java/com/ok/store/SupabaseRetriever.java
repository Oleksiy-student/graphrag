...
/**
 * Retrieves similar chunks from Supabase Vector Table using Qwen3 embeddings.
 */
public class SupabaseRetriever {
  ...
  public List<Hit> retrieve(String query, int k) {
    try {
      ...
      // Build RPC call for vector similarity (PostgREST / Supabase SQL)
      ...
      HttpRequest request = HttpRequest.newBuilder()
          .uri(URI.create(url + "/rest/v1/rpc/vector_search")) // assuming RPC function
